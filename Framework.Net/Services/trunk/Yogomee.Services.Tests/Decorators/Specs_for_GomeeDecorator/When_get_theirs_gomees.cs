...
{
    [TestClass]
    public sealed class When_get_theirs_gomees
    {
        ...
        public static void SetUp(TestContext context)
        {
            ...
            _loadedGomees = _gomeeDecorator.GetTheirsFor(_unitOfWork.MemberRepository.Get(_me.Id));
        }
        ...
        {
            _gomeeDecorator.GetTheirsFor(null);
        }
