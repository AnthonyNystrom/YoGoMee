    ...
    def user_auth_GET(self, authUser, user, request):
        ...
        def complete((profile, gomees)):
            return defer.succeed({
                                  ...
                                  "email" : profile.email,
                                  "twitterLogin" : profile.twitterLogin,
                                  "twitterUpdateOnAddGomee" : profile.twitterUpdateOnAddGomee,
                                  "twitterUpdateOnSaveGomee" : profile.twitterUpdateOnSaveGomee,
                                  "twitterUpdateOnDeleteGomee" : profile.twitterUpdateOnDeleteGomee,
...
from target import TargetsResource
from invitation import InvitationsResource