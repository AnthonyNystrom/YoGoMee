...
class ITargetsResource(IUserResourceBase):
    pass

class ITargetResource(IUserResourceBase):
    pass

class IInvitationsResource(IUserResourceBase):
    pass

class IInvitationResource(IUserResourceBase):
    pass