...
class ITargetService(IService):
    
    def add_target(owner, creator, gomee, data):
        """
        """
    
    def save_target(id, data):
        """
        """
...
class ITagService(IService):
    
    def get_gomee_tags(gomee):
        """
        """ 
    
    def set_gomee_tags(gomee, tags):
        """
        """
